...
export const Form: FC<FormProps> = ({setActive,setShouldRefetch}) => {
    ...
    return (
        <div>
            <h2 className={`text-center text-black title--${theme}`}>Add Car</h2>
            <form
                className={`flex flex-col justify-between gap-2 mt-6 text-black max-w-60 `}
                ...
                <button
                    className={`submit--${theme} text-black border border-black w-20 mt-6 rounded-3xl place-self-center hover:bg-gray-200 hover:bg-opacity-50 transition duration-300`}>
                    Submit
                </button>
            </form>
        </div>
